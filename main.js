...
(function (global) {
  ...
  const translations = {
    en: {
      ...
      tutorialStep2Text: 'Right now you will play Level 1. After the tutorial, you can choose any level.',
      tutorialStep3Title: 'How to play',
      tutorialStep3Text: 'Find the different color, shape or symbol and tap it. Watch the timer!',
    ...
    ru: {
      ...
      tutorialStep2Text: 'Сейчас ты будешь проходить первый уровень. После обучения сможешь выбирать любые уровни.',
      tutorialStep3Title: 'Как играть',
      tutorialStep3Text: 'Найди другой цвет, форму или символ и нажми на него. Следи за таймером!',
    ...
    uk: {
      ...
      tutorialStep2Text: 'Зараз ти проходитимеш перший рівень. Після навчання зможеш вибирати будь-які рівні.',
      tutorialStep3Title: 'Як грати',
      tutorialStep3Text: 'Знайди інший колір, форму чи символ і натисни на нього. Стеж за таймером!',
    ...
    de: {
      ...
      tutorialStep2Text: 'Zuerst spielst du Level 1. Nach dem Tutorial kannst du jedes Level wählen.',
      tutorialStep3Title: 'So spielst du',
      tutorialStep3Text: 'Finde die andere Farbe, Form oder das Symbol und tippe darauf. Achte auf den Timer!',
    ...
    fr: {
      ...
      tutorialStep2Text: 'Pour l\'instant tu joueras au Niveau 1. Après le tutoriel, tu pourras choisir n\'importe quel niveau.',
      tutorialStep3Title: 'Comment jouer',
      tutorialStep3Text: "Trouve la couleur, la forme ou le symbole différent et appuie dessus. Surveille le chrono !",
    ...
    es: {
      ...
      tutorialStep2Text: 'Ahora jugarás en el Nivel 1. Después del tutorial podrás elegir cualquier nivel.',
      tutorialStep3Title: 'Cómo jugar',
      tutorialStep3Text: 'Encuentra el color, forma o símbolo diferente y pulsa sobre él. ¡Mira el temporizador!',
    ...
    it: {
      ...
      tutorialStep2Text: 'Per ora giocherai al Livello 1. Dopo il tutorial potrai scegliere qualsiasi livello.',
      tutorialStep3Title: 'Come giocare',
      tutorialStep3Text: 'Trova il colore, la forma o il simbolo diverso e toccalo. Guarda il timer!',
    ...
    pt: {
      ...
      tutorialStep2Text: 'Agora você jogará no Nível 1. Depois do tutorial poderá escolher qualquer nível.',
      tutorialStep3Title: 'Como jogar',
      tutorialStep3Text: 'Encontre a cor, forma ou símbolo diferente e toque nele. Observe o cronômetro!',
    ...
    pl: {
      ...
      tutorialStep2Text: 'Na razie grasz na Poziomie 1. Po samouczku będziesz mógł wybierać dowolne poziomy.',
      tutorialStep3Title: 'Jak grać',
      tutorialStep3Text: 'Znajdź inny kolor, kształt lub symbol i kliknij go. Pilnuj timera!',
    ...
    tr: {
      ...
      tutorialStep2Text: 'Şimdilik Seviye 1\'de oynayacaksın. Eğitimden sonra istediğin seviyeyi seçebilirsin.',
      tutorialStep3Title: 'Nasıl oynanır',
      tutorialStep3Text: 'Farklı rengi, şekli veya sembolü bul ve üzerine dokun. Zamanlayıcıyı izle!',
    ...
    ar: {
      ...
      tutorialStep2Text: 'الآن ستلعب المستوى ١. بعد التدريب يمكنك اختيار أي مستوى.',
      tutorialStep3Title: 'كيف تلعب',
      tutorialStep3Text: 'ابحث عن اللون أو الشكل أو الرمز المختلف واضغط عليه. راقب المؤقت!',
    ...
    he: {
      ...
      tutorialStep2Text: 'עכשיו תשחק ברמה 1. אחרי ההדרכה תוכל לבחור כל רמה.',
      tutorialStep3Title: 'איך לשחק',
      tutorialStep3Text: 'מצא את הצבע, הצורה או הסמל השונה ולחץ עליה. שים לב לטיימר!',
    ...
    zh: {
      ...
      tutorialStep2Text: '现在你将进行等级1。完成教程后可以选择任意等级。',
      tutorialStep3Title: '怎么玩',
      tutorialStep3Text: '找出不同的颜色、形状或符号并点击它。注意计时器！',
    ...
    ja: {
      ...
      tutorialStep2Text: '今はレベル1でプレイします。チュートリアル後はどのレベルも選べます。',
      tutorialStep3Title: '遊び方',
      tutorialStep3Text: '違う色・形・記号を見つけてタップしてください。タイマーに注意！',
    ...
    ko: {
      ...
      tutorialStep2Text: '지금은 레벨 1을 진행합니다. 튜토리얼 후에는 원하는 레벨을 선택할 수 있어요.',
      tutorialStep3Title: '게임 방법',
      tutorialStep3Text: '다른 색, 모양 또는 기호를 찾아 누르세요. 타이머를 확인하세요!',
